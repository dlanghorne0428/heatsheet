...
class Heat():
    def __init__(self, dancer, partner, category, line):
        self.dancer = dancer
        ...
        for line in fhand:
            ...
            if "Heat " in line:
                if couple is not None:
                    ...
                    heat_obj = Heat(dancer.name, partner, "Heat", line)
            ...
            if "Solo " in line:
                if couple is not None:
                    # turn this line into a heat object and add it to the couple and dancer
                    solo_obj = Heat(dancer.name, partner, "Solo", line)
            ...
            if "Pro heat " in line:
                if couple is not None:
                    ...
                    pro_heat = Heat(dancer.name, partner, "Pro heat", line)
            ...
            if "Formation" in line:
                if dancer is not None:
                    # turn that heat info into an object and add it to the couple
                    form_heat = Heat(dancer.name, "", "Formation", line)
